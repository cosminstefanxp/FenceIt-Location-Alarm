 ...
 * favorite and name.
 */
public abstract class AbstractLocationActivity2<T extends AbstractAlarmLocation> extends DefaultActivity {

	protected Logger log = Logger.getLogger(AbstractLocationActivity2.class);
